...
import {bookingRequest,RejectBooking,AcceptBooking,getBookingRequestTourist,getBookingRequestGuide,getBookedBookingGuide,getBookingHistoryTourist,getBookedRequestTourist,cancelBooking}
...
const router=Router();
router.route("/bookings").post(reqbody,verifyjwt,bookingRequest)
...
router.route("/guide/upcoming-bookings").get(verifyjwt,getBookedBookingGuide)
router.route("/tourist/upcoming-bookings").get(verifyjwt,getBookedRequestTourist)
router.route("/booking/history").get(verifyjwt,getBookingHistoryTourist)
